      ...
      <div className="group aspect-[100/127] border rounded-lg flex flex-col justify-center overflow-hidden">
        <div className="relative flex-1 bg-amber-50">
          ...
          <Actions id={id} title={title} side="right">
            <button className="absolute top-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity px-3 py-2"> <MoreHorizontal className="text-white opacity-75 hover:opacity-10 transition-opacity" /> </button>
          </Actions>
        </div>
        <Footer
